...
lambda_background = 10000/time_end;
%% set the parameters:
C = 1000; % cache size
...
lambda_a = 0.1* lambda_background; % maximum probing rate 
...
n_eqs = 5; %[2 4 6 8]; % #probing experiments (at least 4)
...
N_flows_a = [10 50 80 100 120]; %[30 50 100 200 500]; %[50 100 300 500];
...
% policy = 'FIFO'; policy_wrong = 'LRU';
policy = 'LRU'; policy_wrong = 'FIFO';
N_flows_a = [10 50 80 100 120]; %[50 100 300 500];
...
%  'C_est_ideal','F_est_ideal','lambda_est_ideal','alpha_est_ideal',  ,'A_EST1','C_EST2','F_EST2','L_EST2','A_EST2'
%% save data if satisfactory:
if ~debug
    save(['data/joint_inference_' policy '_2round.mat'], 'Time_end', 'N_flows_a',...
        'C_EST1','F_EST1','L_EST1','C','F','lambda_background','alpha','xlabels');
end
