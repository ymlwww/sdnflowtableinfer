...
save('data/policy_N.mat', 'Pe','Probes','N','lm_background','C','lm_a');    
...
%     end
% end
% % save('data/policy_rate.mat', 'Pe','Probes','n','lm_background','C','Lm_a');  
% % save('data/policy_rate67.mat', 'Pe','Probes','n','lm_background','C','Lm_a'); 
% %%
...
%     end
% end
% save('data/policy_Cest.mat', 'Pe','Probes','n','lm_background','C','lm_a','C_est_total');  
% 
